...
def book_timeslot(event_name, event_description, event_date, event_time, input_email):
    ...
    start_time = str(event_date)[:10] + 'T' + event_time + ':00+08:00'
    end_time = str(event_date)[:10] + 'T' + str(int(event_time[:2]) + 1) + ':00:00+08:00'
    # ----------------------------------------------------------------------------
    ...
    if not events:
        event = {
            ...
            'attendees': [
                {'email': 'studentsaversorbital@gmail.com'},
